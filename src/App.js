...
//   };
//   const delPath = (pid) => {
//     if (!confirm("Delete path and all its lines/stations?")) return;
//     if (preStaffMode && preStaffShift) {
//       const cfg = getShiftConfig(preStaffShift);
...
//   };
//   const delLine = (lid) => {
//     if (!confirm("Delete line and all its stations?")) return;
//     if (preStaffMode && preStaffShift) {
//       const cfg = getShiftConfig(preStaffShift);
...
//           <button onClick={e=>{e.stopPropagation();if(confirm("Delete station?"))delSt(st.id);}} style={{background:"none",border:"none",cursor:"pointer",fontFamily:"'DM Mono',monospace",fontSize:"0.5rem",color:C.red,padding:"1px 3px"}}>✕</button>
//         </div>
//       </div>
//     );
//   };
